...
{{- if .Values.global.api.rateLimits.enabled }}
- name: GORILLA_LIMITER
  value: "{{ include "wandb.redis.connectionString" . | trim }}"
- name: GORILLA_DEFAULT_RATE_LIMITS_FILESTREAM_COUNT
  value: "{{ .Values.global.api.defaultRateLimits.filestreamCount }}"
- name: GORILLA_DEFAULT_RATE_LIMITS_FILESTREAM_SIZE
  value: "{{ .Values.global.api.defaultRateLimits.filestreamSize }}"
- name: GORILLA_DEFAULT_RATE_LIMITS_FILESTREAM_PER_RUN_COUNT
  value: "{{ .Values.global.api.defaultRateLimits.fileStreamPerRunCount }}"
- name: GORILLA_DEFAULT_RATE_LIMITS_RUN_UPDATE_COUNT
  value: "{{ .Values.global.api.defaultRateLimits.runUpdateCount }}"
- name: GORILLA_DEFAULT_RATE_LIMITS_SDK_GRAPHQL_QUERY_SECONDS
  value: "{{ .Values.global.api.defaultRateLimits.sdkGraphqlQuerySeconds }}"
- name: GORILLA_DEFAULT_RATE_LIMITS_CREATE_ARTIFACTS
  value: "{{ .Values.global.api.defaultRateLimits.createArtifacts }}"
- name: GORILLA_DEFAULT_RATE_LIMITS_CREATE_ARTIFACTS_TIME_WINDOW
  value: "{{ .Values.global.api.defaultRateLimits.createArtifactsTimeWindow }}"
{{- else }}
- name: GORILLA_LIMITER
  value: "noop://"
{{- end }}
