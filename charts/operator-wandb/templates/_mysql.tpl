...
The certificate is already mounted at /etc/ssl/certs/mysql_ca.pem */}}mysql://$(MYSQL_USER):$(MYSQL_PASSWORD)@$(MYSQL_HOST):$(MYSQL_PORT)/$(MYSQL_DATABASE)?tls=preferred&ssl-ca=/etc/ssl/certs/mysql_ca.pem
{{- else -}}
