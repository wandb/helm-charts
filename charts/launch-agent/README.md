...
| `sshKeyPath`                   | string          | No                   | ""                              | Name of the file as mounted containing the ssh creds. |
| `sshKeySecretKey`              | string          | No                   | ""                              | Name of the key in the secret containing ssh credentials. |
