...
INSTALLER_ID="testing-wandb"
KURL_VERSION="v2023.05.25-0"
CRICTL_VERSION=1.20.0
REPLICATED_APP_URL="https://replicated.app"
KURL_UTIL_IMAGE="replicated/kurl-util:v2023.05.25-0"
KURL_BIN_UTILS_FILE="kurl-bin-utils-v2023.05.25-0.tar.gz"
...
spec:
  ...
  kotsadm:
    applicationSlug: testing-wandb
    version: 1.100.0
    s3Override: https://s3.kurl.sh/external/kotsadm-1.100.0.tar.gz
  ekco:
    version: 0.27.1
  kurl:
    installerVersion: v2023.05.25-0
